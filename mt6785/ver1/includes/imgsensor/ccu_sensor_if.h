...
typedef kal_uint16 (*PFN_TIME_TO_LINE_COUNT)(kal_uint32);
typedef CCU_ERROR_T (*PFN_CONTROL)(uint32_t);
typedef kal_uint32 (*PFN_SET_MAX_FRAMERATE_BY_SCENARIO)(uint32_t, MUINT32);
