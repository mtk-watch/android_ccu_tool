...
LOCAL_LDFLAGS1 += -Wl,--script=$(CCU_TOOL_LENS_DIR)/lens1.ld
LOCAL_LDFLAGS2 += -Wl,--script=$(CCU_TOOL_LENS_DIR)/lens2.ld

LOCAL_CFLAGS += -I$(CCU_TOOL_LENS_DIR)/includes
LOCAL_CFLAGS += -I$(CCU_TOOL_LENS_DIR)/includes/lens
LOCAL_CFLAGS += -I$(CCU_TOOL_LENS_DIR)/includes/ccu_main
LOCAL_CFLAGS += -I$(CCU_TOOL_LENS_DIR)/includes/ccu_ext_interface
