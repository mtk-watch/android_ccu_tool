...
LOCAL_CFLAGS += -I$(CCU_TOOL_CUSTSENSOR_DIR)/includes
LOCAL_CFLAGS += $(addprefix -I,$(my_ccu_src_path))

LOCAL_ASFLAGS += -mcpu=$(MD32_VER)

LOCAL_LDFLAGS1 += -T $(CCU_TOOL_CUSTSENSOR_DIR)/custsensor1.sc
LOCAL_LDFLAGS2 += -T $(CCU_TOOL_CUSTSENSOR_DIR)/custsensor2.sc
