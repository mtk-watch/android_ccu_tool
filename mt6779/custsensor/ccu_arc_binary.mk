...
LOCAL_LDFLAGS1 += -Wl,--script=$(CCU_TOOL_CUSTSENSOR_DIR)/custsensor1.ld
LOCAL_LDFLAGS2 += -Wl,--script=$(CCU_TOOL_CUSTSENSOR_DIR)/custsensor2.ld

LOCAL_CFLAGS += -I$(CCU_TOOL_CUSTSENSOR_DIR)/include
LOCAL_CFLAGS += -I$(CCU_TOOL_CUSTSENSOR_DIR)/include/custsensor
