...
sensor_driver_src_custsensor  ?= $(TOP)/vendor/mediatek/proprietary/custom/$(MTK_PLATFORM_DIR)/hal/imgsensor/ver1
my_ccu_src_path :=
...
my_ccu_binary_mk := $(CCU_TOOL_CUSTSENSOR_DIR)/ccu_$(strip $(MTK_CCU_TOOLCHAIN_VERSION))_binary.mk
...
$(foreach c,$(CUSTOM_KERNEL_IMGSENSOR),\
    ...
    $(eval include $(CCU_TOOL_CUSTSENSOR_DIR)/ccu_extract.mk)\
    $(if $(BUILD_SYSTEM),$(eval include $(my_ccu_binary_mk)))\
)
else
$(info $(my_ccu_kernel_path)/drivers/misc/mediatek/imgsensor/inc/kd_imgsensor.h is not exist)
endif
