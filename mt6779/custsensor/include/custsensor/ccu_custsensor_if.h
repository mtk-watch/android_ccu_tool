...
typedef enum
{
    CCU_AE_CUSTOM_TRANSFORM_START = 0,
    CCU_AE_CUSTOM_TRANSFORM_BINSUM = CCU_AE_CUSTOM_TRANSFORM_START,
    CCU_AE_CUSTOM_TRANSFORM_ATR,
    CCU_AE_CUSTOM_TRANSFORM_NUM
} CCU_AE_CUSTOM_TRANSFORM_ENUM;

/******************************************************************************
* Define types of function pointers
******************************************************************************/
typedef	unsigned int (*PFN_CUSTSENSOR_CONTROL)(CCU_AE_CUSTOM_TRANSFORM_ENUM const,void* const );
...
/******************************************************************************
* Cust sensor function table
******************************************************************************/
typedef struct CUST_SENSOR_TABLE
{   
    unsigned int u2TableSize;
    PFN_CUSTSENSOR_CONTROL pfncustsensorcontrol;
