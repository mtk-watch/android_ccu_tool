...
enum CCU_MSDK_SENSOR_FEATURE_ENUM
{
    ...
    CCU_SENSOR_FEATURE_SET_HDR_SHUTTER        ,
    CCU_SENSOR_FEATURE_SET_DUAL_GAIN          ,
    CCU_SENSOR_FEATURE_SET_HDR_TRI_SHUTTER    ,
    CCU_SENSOR_FEATURE_SET_HDR_TRI_GAIN       ,
    CCU_SENSOR_FEATURE_SET_HDR
};
