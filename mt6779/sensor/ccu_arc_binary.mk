...
LOCAL_LDFLAGS1 += -Wl,--script=$(CCU_TOOL_SENSOR_DIR)/sensor1.ld
LOCAL_LDFLAGS2 += -Wl,--script=$(CCU_TOOL_SENSOR_DIR)/sensor2.ld

LOCAL_CFLAGS += -I$(CCU_TOOL_SENSOR_DIR)/includes
LOCAL_CFLAGS += -I$(CCU_TOOL_SENSOR_DIR)/includes/imgsensor
LOCAL_CFLAGS += -I$(CCU_TOOL_SENSOR_DIR)/includes/ccu_main
LOCAL_CFLAGS += -I$(CCU_TOOL_SENSOR_DIR)/includes/ccu_ext_interface
