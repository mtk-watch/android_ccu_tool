...
my_ccu_src_path ?= $(my_ccu_kernel_path)/drivers/misc/mediatek/imgsensor/src/$(MTK_PLATFORM_DIR)
...
my_ccu_max_code ?= 2900

ifneq ($(wildcard $(my_ccu_kernel_path)/drivers/misc/mediatek/imgsensor/src/$(MTK_PLATFORM_DIR)),)
